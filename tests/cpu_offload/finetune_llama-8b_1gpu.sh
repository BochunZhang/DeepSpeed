...
echo "================================================"
echo "Llama-3.1-8B Fine-tuning with DeepSpeed on 1 GPU"
echo "================================================"
...
OUTPUT_DIR="${SCRIPT_DIR}/llama-3.1-8b_${MODE}_output"
DS_CONFIG_JSON="${SCRIPT_DIR}/llama-3.1-8b_${MODE}_config.json"
...
USE_WANDB=false
WANDB_PROJECT="llama-3.1-8b"
WANDB_RUN_NAME="llama-3.1-8b-$MODE"
DETERMINISTIC=false
BENCH_STEPS=10
WARMUP_STEPS=20
