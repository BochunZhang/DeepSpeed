...
echo "================================================"
echo "Qwen2.5-72B-Instruct Fine-tuning with DeepSpeed on 4 GPU"
echo "================================================"
...
USE_WANDB=false
WANDB_PROJECT="qwen2.5-72b"
WANDB_RUN_NAME="qwen2.5-72b-${MODE}"
DETERMINISTIC=false
NUM_ITERS=10
...
echo "Qwen2.5-72B | mode=${MODE} gbs=${GBS} mbs=${MBS} gas=${GAS} (derived) cpu_ratio=${CPU_RATIO} profile=${PROFILE}"
