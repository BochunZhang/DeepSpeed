...
# DeepSpeed Team
#
# Full benchmark sweep for Qwen3-14B on 4 GPUs.
#
# Modes tested:
...
#   bash tests/cpu_offload/run_qwen3-14b.sh
set -eo pipefail

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
FINETUNE="${SCRIPT_DIR}/finetune_qwen3-14b_4gpu.sh"
CPU_RATIO=0.90   # used by superoffload and zeroinfinity-superoffload

echo "========================================================"
echo "Qwen3-14B Full Benchmark Sweep (32 runs)"
echo "========================================================"
